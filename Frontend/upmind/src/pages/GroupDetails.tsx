                  ...
                  <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-4">
                      <div className="rounded-2xl border border-zinc-200 bg-[#FFFBF2] p-4">
                        ...
                        <p className="mt-1 text-3xl font-semibold text-amber-600/90 tabular-nums">
                          {data.streak}
                        </p>
                      ...
                      <div className="rounded-2xl border border-zinc-200 bg-[#FFFBF2] p-4">
                        ...
                        <p className="mt-1 text-3xl font-semibold text-blue-600 tabular-nums">
                          {data.xp}
                        </p>
                        <p className="mt-1 text-[11px] text-zinc-500">total</p>
                      </div>
                    </div>
